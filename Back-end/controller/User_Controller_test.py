...
if __name__ == "__main__":
    ...
    user1 = User("pete_the_great@gmail.com", "sqllover123", False, "Pete")
    user1.portfolio_id = 1
    user2 = User("jdoe89@hotmail.com", "27051989", False, "John Doe")
    user2.portfolio_id = 2
    user3 = User("casandrawilliams@gmail.com", "cswl897", False, "Caswill")
 ...
 # Caso de uso 1: Usuario erróneo
    ...
    # Caso de uso3: Usuario y contraseña correctos
    print("Caso de uso 3: Usuario y contraseña correctos. Se espera loguearse exitosamente")

    try:
        test_user = User_Controller.login("jdoe89@hotmail.com", "27051989")
        print(
